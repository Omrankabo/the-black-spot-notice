...
export default function NotesCard(){
    return (
        <Link to='note' className="mx-auto flex max-w-xl w-full items-center justify-between outline outline-black/5 hover:bg-black/5">
            {
                //icon
            }
            ...
            <div className="shrink-0 max-w-4/5 ">
